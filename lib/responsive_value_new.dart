...
/// determined by [Condition]s set in [conditionalValue].
...
class ResponsiveValue<T> {
  ...
  final List<Condition<T>> conditionalValue;

  final BuildContext context;

  ResponsiveValue(this.context,
      {required this.defaultValue, required this.conditionalValue}) {
    // Breakpoint reference check. Verify a parent
    // [ResponsiveWrapper] exists if a reference is found.
    if (conditionalValue.firstWhereOrNull((element) => element.name != null) != null) {
      try {
    ...
    conditions.addAll(conditionalValue);
...
class ResponsiveVisibility extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    visibleValue = ResponsiveValue(context,
            defaultValue: visibleValue, conditionalValue: conditions)
        .value;
...
class ResponsiveConstraints extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    constraintValue = ResponsiveValue(context,
            defaultValue: constraintValue, conditionalValue: constraintsWhen)
        .value;
