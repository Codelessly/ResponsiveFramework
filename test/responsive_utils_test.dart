...
void main() {
  group('Breakpoint Comparator', () {
    test('Sort Types', () {
      ...
      breakpoints.sort(ResponsiveUtils.responsiveBreakpointComparator);
      ...
      expect(
          breakpoints[3], const ResponsiveBreakpoint.tag(450, name: 'DEFAULT'));
    });
    test('Sort Mixed', () {
      List<ResponsiveBreakpoint> breakpoints = [
    ...
    test('Sort Duplicates', () {
      ...
      expect(
          breakpoints[5], const ResponsiveBreakpoint.tag(450, name: 'DEFAULT'));
    });
  });
}
